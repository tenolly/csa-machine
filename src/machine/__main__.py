...
class Simulation:
    def __init__(
        ...
        self.simulation_dirname: str = "simulation"
    ...
    def make_memory_log(self):
        ...
        memory_dump_filename = os.path.join(self.simulation_dirname, "memory.log")
    ...
    def make_execution_log(self):
        ...
        simulation_filename = os.path.join(self.simulation_dirname, "execution.log")
    ...
    def make_output_log(self):
        ...
        output_filename = os.path.join(self.simulation_dirname, "output.txt")
